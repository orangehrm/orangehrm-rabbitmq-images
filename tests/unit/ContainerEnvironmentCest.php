...
class ContainerEnvironmentCest
{
    ...
    public function vefiryOSVersionTest (UnitTester $I)
    {
        ...
        $I->runShellCommand("docker exec dev_rabbitmq cat /etc/os-release | grep PRETTY_NAME | cut -d'=' -f 2"); 
    ...
    public function vefiryInstalledRabbitMQVersionTest (UnitTester $I)
    {
        ...
        $I->runShellCommand("docker exec dev_rabbitmq rabbitmqctl --version"); 
